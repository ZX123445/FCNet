...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='F:/CoCOD8K_新/train/',
                        help='the training rgb images root')
    parser.add_argument('--val_root', type=str, default='F:/CoCOD8K_新/test/',
                        help='the test rgb images root')
    parser.add_argument('--save_path', type=str,
                        default='./weight/',
                        help='the path to save model and log')
    # # swin argument
    # parser.add_argument('--cfg', type=str, default="configs/swin_base_patch4_window7_224_22k.yaml", metavar="FILE",
